...
<div class="p-2 p-md-4">
    ...
    <div class="mb-4">
        <h2 class="text-white fw-bold mb-1">Jumlah Kematian</h2>
        <p class="text-secondary">Statistik angka kematian di Kelurahan Kartasura</p>
    </div>
    ...
    <div class="card bg-dark border-0 shadow-sm mb-5" style="border-radius: 12px; border: 1px solid rgba(255,255,255,0.1) !important;">
        <div class="card-body p-4">
            <form action="{{ route('kematian') }}" method="GET" class="d-flex align-items-center gap-3 flex-wrap">
            ...
            <div class="card bg-dark border-0 shadow-sm h-100" style="border-radius: 16px; border: 1px solid rgba(255,255,255,0.05) !important;">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-4">
                        <!-- Ikon Kematian (Warna Merah/Danger) -->
                        <div class="bg-danger bg-opacity-25 p-3 rounded-3 text-danger me-3 d-flex align-items-center justify-content-center">
                        ...
                        <div>
                            <h6 class="text-secondary fw-bold mb-0" style="letter-spacing: 0.5px;">TOTAL KEMATIAN</h6>
                        </div>
                    </div>
                    <h2 class="text-danger fw-bold display-5 mb-0">{{ number_format($total_kematian, 0, ',', '.') }} <span class="fs-5 text-secondary fw-normal">Jiwa</span></h2>
                </div>
            </div>
        </div>
    </div>
